package queue.domain.queue.controller;
...
import queue.domain.queue.service.QueueService;
import queue.global.apiPayload.CommonResponse;
import queue.global.apiPayload.code.GeneralSuccessCode;
